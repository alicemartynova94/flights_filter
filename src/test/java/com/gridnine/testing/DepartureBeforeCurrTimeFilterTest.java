...
public class DepartureBeforeCurrTimeFilterTest {
    ...
    void init() {
        ...
        flightFilter = new DepartureBeforeCurrTimeFilter();
    ...
    void filterListWithAllInvalidFlightsExpectEmptyList() {
        flightsToBeFiltered.add(createFlight(LocalDateTime.now().minusDays(3), LocalDateTime.now().plusDays(3).plusHours(3)));
        flightsToBeFiltered.add(createFlight(LocalDateTime.now().minusDays(2), LocalDateTime.now().plusDays(3).plusHours(3)
                , LocalDateTime.now().minusDays(6), LocalDateTime.now().plusDays(3).plusHours(7)));
    ...
    void filterListWithInvalidAndValidFlightsExpectEqual() {
        ...
        flightsToBeFiltered.add(createFlight(LocalDateTime.now().minusDays(3), LocalDateTime.now().minusDays(3).plusHours(3)));
